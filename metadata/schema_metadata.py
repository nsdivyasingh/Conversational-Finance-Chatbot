...
PAYROLL_COMPONENT_GROUPS = {
    "earnings": [
        "basic_salary", "hra", "lta", "gratuity", "leave_encashment",
        "management_allowance", "bonus", "other_allowance",
        "yearly_bonus", "incentive", "night_shift_allowance",
        "sign_tenure_bonus", "referral_bonus", "notice_period_pay",
        "misc_earnings", "salary_advance", "tele_reimbursement",
        "joining_bonus", "relocation_allowance",
        "professional_development", "maternity_bonus",
        "gross_salary"
    ],
    "deductions": [
        "pf_deduction", "pt_deduction", "esi_deduction",
        "vpf_deduction", "income_tax_deduction",
        "lwf_deduction", "salary_advance_deduction",
        "notice_period_deduction", "medical_insurance_deduction",
        "other_deductions", "other_deduction_2",
        "total_deductions"
    ]
}